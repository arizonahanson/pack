...
highlight CursorLineNr ctermbg=NONE ctermfg=7 cterm=NONE
highlight Visual ctermbg=8 cterm=NONE
highlight StatusLine ctermbg=8 ctermfg=7 cterm=NONE
highlight StatusLineNC ctermbg=8 ctermfg=0 cterm=NONE
highlight WildMenu ctermbg=8 ctermfg=15 cterm=NONE
highlight PmenuThumb ctermfg=7
highlight Underlined ctermbg=NONE ctermfg=4 cterm=underline
highlight IncSearch ctermbg=8 ctermfg=3 cterm=NONE
highlight Search ctermbg=8 ctermfg=NONE cterm=NONE
highlight MatchParen ctermbg=8 ctermfg=3 cterm=NONE
...
highlight! link StatusLineTermNC StatusLineN
